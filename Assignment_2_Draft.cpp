...
int PathCheck(int CurrentX, int CurrentY, char NPos, char EPos, char SPos, char WPos)
{
    ...
    if(CurrentX-1<0||CurrentX+1>30||CurrentY-1<0||CurrentY+1>45){ //If going out of bounds, perform a backtrack process.
        Direction=6;
        k++;
    }
    ...
    else if(CurrentX-1<1||CurrentX+1>30||CurrentY-1<0||CurrentY+1>45){ //If going out of bounds, perform a backtrack process.
        Direction=6;
    }
